<template>
  <h1 class="text-4xl">Available Episodes:</h1>
  <div class="max-w-full mx-auto my-8 shadow-lg overflow-y-auto h-96 p-10">
    ...
    <div
      ...
      <router-link
        ...
        class="episode-link group rounded-lg shadow-md overflow-hidden bg-white transform hover:scale-105 transition duration-300 ease-in-out hover:shadow-lg">
        <img
        ...
        <div class="p-4">
          ...
          <p class="text-md text-gray-600">{{ episode.episode }}</p>
        </div>
      </router-link>
    </div>
