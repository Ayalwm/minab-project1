    ...
    <div class="p-6">
      <div
        ...
        <div
          ...
          class="bg-white border border-gray-200 rounded-lg shadow-md p-6 cursor-pointer hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
